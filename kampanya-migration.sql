...
DROP POLICY IF EXISTS "Sadece adminler kampanya geçmişini görebilir" ON public.kampanya_gecmisi;
DROP POLICY IF EXISTS "Admin kampanya gorebilir" ON public.kampanya_gecmisi;
...
DROP POLICY IF EXISTS "Sadece adminler kampanya ekleyebilir" ON public.kampanya_gecmisi;
DROP POLICY IF EXISTS "Admin kampanya ekleyebilir" ON public.kampanya_gecmisi;
